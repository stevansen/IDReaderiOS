...
public enum StringKey: String, Sendable, CaseIterable {
    ...
    case menuNotice = "menu_notice"
    case menuAbout = "menu_about"
    case aboutTitle = "about_title"
    case aboutAuthorsTitle = "about_authors_title"
    case aboutAuthorsText = "about_authors_text"
    case aboutLicenceTitle = "about_licence_title"
    case aboutLicenceText = "about_licence_text"
    case aboutThirdPartyTitle = "about_thirdparty_title"
    case aboutThirdPartyText = "about_thirdparty_text"
    case aboutRepository = "about_repository"
